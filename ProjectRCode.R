##########################################################
####      Network Analysis of FLixster Network        ####
####                                                  ####
####                Gnana Teja Peddi                  ####
####                                                  ####
##########################################################
...
getwd()
dir_path <-"C:/Users/shahr/Desktop/MSBA 2019/Courses/IDS 564 Social Media and Network Analysis/Project"
setwd(dir_path)
...
el = read.csv("dataFlixster/edges.csv", header=F)
nl = read.csv("dataFlixster/nodes.csv", header=F)
